 ...
 */
@Embeddable
public class MetricPK implements Serializable {
    ...
    public MetricPK(int id, int deviceid, int devicetypeindicatorid) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MetricPK)) {
            return false;
        }
        MetricPK other = (MetricPK) object;
        if (this.id != other.id) {
            return false;
        }
    ...
    public String toString() {
        return "com.yk.MetricPK[ id=" + id + ", deviceid=" + deviceid + ", devicetypeindicatorid=" + devicetypeindicatorid + " ]";
    }
